...
详细文档见：[http://doc.autopoi.jeecg.com](http://doc.autopoi.jeecg.com)
...
| 自定义视图 | 用途 |  描述 |
| ------ | ------ | ------ |
| JeecgEntityExcelView | 实体对象导出视图 | 例如：List < JeecgDemo>  list  |
| JeecgMapExcelView | Map对象导出视图 | List<Map<String, String>> list |
...
| numFormat      | String   | ""               | 数字格式化,参数是Pattern,使用的对象是DecimalFormat ,请在数值类型的字段上使用   [用法参考 ]([https://www.jianshu.com/p/b3699d73142e](https://www.jianshu.com/p/b3699d73142e))                           |
